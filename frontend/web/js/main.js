...
/* Full nav begin */
	...
	$(".full_nav .left_side .categories_list ul li a, .full_nav .left_side .top_categories > ul > li > a").mouseover(function(){
		$(".full_nav .right_side").removeClass("hide_me");
		...
		if (_window.width() > 992) {
			...
			if ($(this).hasClass('hide_children')) {
				$(".full_nav .right_side").addClass("hide_me");
				return false;
			}
...
/* Nav begin */
	...
	$(".full_nav .left_side .cat_list a").click(function () {
		var _this = $(this);
		...
		if (!_this.hasClass('see_all') && _window.width() < 992 && list.length && list.children().length) {
...
$(".priduct_gallery .thumbnails .thumb").click(function(e) {
	e.preventDefault();

	var currentIndex = $(this).index();
	var arrowNext = $(".priduct_gallery .thumbnails .arrows a.next");
	var arrowPrev = $(".priduct_gallery .thumbnails .arrows a.prev");
