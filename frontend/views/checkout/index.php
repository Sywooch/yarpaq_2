                                ...
                                <div class="col-md-8">
                                    <div class="col-md-6  col-sm-6 no-padding padding-xs-0 padding-sm-0">
                                        ...
                                        <div class="delivery-method">
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="radio" class="radio" id="radio1" name="method_delivery"/>
                                                ...
                                                <li>
                                                    <input type="radio" class="radio" id="radio2"  name="method_delivery" />
                                    ...
                                    <div class="col-md-6  col-sm-6 padding-xs-0  padding-sm-0">
                                        <div class="payment-method">
                                            ...
                                            <ul>
                                                <li>
                                                    <input type="radio" class="radio" id="radio3" name="payment_method" value="pp_standard">
                                                    <label for="radio3"><div class="payPal"></div></label>
                                                </li>
                                                <li>
                                                    <input type="radio" class="radio" id="radio4" name="payment_method" value="goldenpay">
                                                ...
                                                <li>
                                                    <input id="radio5" type="radio" class="radio" name="payment_method" value="cod">
                                                    <label for="radio5"><?= Yii::t('app', 'Cash'); ?></label>

                                                </li>
                                                <li>
                                                    <input id="radio6" type="radio" class="radio" name="payment_method" value="cheque">
                                                    <label for="radio6"><?= Yii::t('app', 'Post'); ?></label>
                                                </li>
                                                <li>
                                                    <input id="radio7" type="radio" class="radio" name="payment_method" value="millikart">
