                        ...
                        <form action="<?= Language::getCurrent()->urlPrefix . '/search'; ?>" method="get">
                            <div class="form-search">
                                ...
                                <div class="form-group input-search input-serach">
                                    <input placeholder="<?= Yii::t('app', 'Enter product name'); ?>..."
                                           class="search_query" name="q" autocomplete="off" type="text"
                    ...
                    <ul class="list-inline dejavu-bold">
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown"
                               href="#"><?= Language::getCurrent()->name; ?></a>
                                ...
                                <li>
                                    <div class="dropdown dropdown-bag">
                                        ...
                                        <a href="<?= \yii\helpers\Url::toRoute(['/cart']); ?>"
                                           class="cart-icon iconBag bag-link"><?= $cart->countProducts(); ?></a>
                                        ...
                                        <div class="dropdown-menu bag-drop">
                                                    ...
                                                    <div class="row margin-top-10">
                                                        <div class="col-lg-7 col-md-7 col-xs-7 col-sm-7 no-padding-xs">
                                                            <div class="row">
                                                                ...
                                                                <div
                                                                    class="col-lg-3 col-md-3 col-xs-3 col-sm-3 no-padding-xs">
                                                                    <img class="img-rounded"
                                                                         src="<?= $product['image']; ?>" width="50"
                                                                         alt="">
                                                                </div>
                                                        ...
                                                        <div class="col-lg-5 col-md-5 col-xs-5 col-sm-5 no-padding-xs">
                                                            <div class="row">
                                                                <div
                                                                    ...
                                                                    <div
                                                                        class="col-lg-12 col-md-12 col-sm-12 no-padding-xs">
                                            ...
                                            <div
                                                class="col-lg-12 col-md-12 col-sm-12 col-xs-12 checkout-proses padding5">
                                                <hr class="white">
                                                <div class="row">
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <p class="total-price small">
                                                                <span><?= Yii::t('app', 'Subtotal'); ?>:</span></p>
                                                        </div>

                                                        <div
                                                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding-left no-padding-right">
                                                            <p class="total-price small">
                                                                <span><strong><?= Yii::t('app', 'Total'); ?>
                                                                        :</strong></span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 no-padding-xs">
                                                        ...
                                                        <span class="g-price small pull-right"><?= $cart->subtotal; ?>
                                                            <b
                                                        ...
                                                        <div
                                                            class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding no-padding-xs">
                                                            <strong>
                                                            <span class="g-price small pull-right"><?= $cart->total; ?>
                                                                <b
                                                                    class="manatFont">M</b></span>
                                                            </strong>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 no-padding-xs">
                                                        <a href="<?= \yii\helpers\Url::toRoute(['cart/index']); ?>"
                                                           type="button"
                                                           class="btn-grey btn btn-link"><?= Yii::t('app', 'Go to cart'); ?></a>
                                                    </div>

                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 no-padding-xs">
                                                        <a class="button_drop greenBg col-md-12 pull-right"
                                                           href="<?= \yii\helpers\Url::toRoute(['/checkout']) ?>">
                                                            <?= Yii::t('app', 'Checkout'); ?>
                                                        </a>
                                                    </div>
                                                </div>
                                ...
                                <li>
                                    ...
                                    <div class="dropdown dropdown-cart">
                                        <a id="access_link" data-toggle="dropdown"
                                           class="dropdown-toggle login-link <?= !Yii::$app->user->isGuest ? 'loggedIn' : ''; ?>"
                                           href="#">
                                        ...
                                        <?php if (Yii::$app->user->isGuest) { ?>
                                            <div class="dropdown-menu">
                                                <div class="col-md-12">
                                                    ...
                                                    <form action="<?= Language::getCurrent()->urlPrefix; ?>/login"
                                                          method="post" id="loginForm">
                                                        <div class="form-group">
                                                            <input placeholder="<?= Yii::t('app', 'Email'); ?>"
                                                                   id="inputUsernameEmail"
                                                                   class="form-control" type="text"
                                                                   name="LoginForm[email]">
                                                        </div>
                                                        <div class="form-group margin-bottom-10">
                                                            <input placeholder="<?= Yii::t('app', 'Password'); ?>"
                                                                   id="inputPassword" class="form-control"
                                                                   type="password" name="LoginForm[password]">
                                                        </div>
                                                        <a href="#" class="hide"
                                                           id="forgot_pw"><?= Yii::t('app', 'Restore password'); ?></a>
                                                        <input type="hidden" name="<?= Yii::$app->request->csrfParam ?>"
                                                               value="<?= Yii::$app->request->getCsrfToken() ?>">
                                                        <input class="button_drop greenBg pull-right"
                                                               value="<?= Yii::t('app', 'Sign in'); ?>"
                                                               type="submit">
                                                        ...
                                                        <a href="<?= Language::getCurrent()->urlPrefix; ?>/registration"
                                                           class="button_drop greenBg col-md-12"><?= Yii::t('app', 'Register'); ?></a>
                                                    </form>
                                                </div>
                                            </div>
                                        <?php } else { ?>
                                            <div class="dropdown-menu cabinet">
                                                <div class="col-md-12">
                                                    ...
                                                    <a href="#"
                                                       id="own_info"><?= Yii::t('app', 'Personal information'); ?></a>

                                                    <div class="clearfix"></div>

                                                    <a id="exit_link" class="exit-link"
                                                       href="<?= Language::getCurrent()->urlPrefix; ?>/logout"><?= Yii::t('app', 'Logout'); ?></a>
                                                </div>
                                            </div>
                                        <?php } ?>
